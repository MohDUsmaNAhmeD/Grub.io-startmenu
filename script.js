...
function gameOver() {
  ...
  window.location.href = "Grub-io-by-usman.vercel.com"
  initGame();
}
...
function gameOver() {
  alert(`Game Over! Your score: ${playerSnake.score}`);
  window.location.href="C:/Users/Wajahat Traders/Coding/New Folder/slither.io/Grub-io-by-usman.vercel.comnu/index.html"
}
